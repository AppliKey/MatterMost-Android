 ...
 */
public abstract class SubscribeableRealmRecyclerViewAdapter<T extends RealmModel, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public SubscribeableRealmRecyclerViewAdapter(@NonNull Context context,
                                                 @Nullable OrderedRealmCollection<T> data,
                                                 boolean hasAutoUpdates) {
    ...
    public void disableAutoUpdates() {
